...
function autonotify_enqueue_assets() {
    wp_enqueue_script('homeScript', plugins_url('public/js/home.js', ''), array(), date('YmdHis'), true);
    wp_enqueue_style('homeStyle', plugins_url('public/css/home.css', ''), array(), date('YmdHis'));
    // Font Awesome
